...
serializer.tsk: serializer/example.cpp serializer/core.h serializer/json.h serializer/json/impl.h
	clang++ -I. serializer/example.cpp -std=c++11 -O2 -o serializer.tsk

test.tsk: tests/serializer/json/test.cpp serializer/core.h serializer/json.h serializer/json/impl.h
